...
green_line <- google_directions(origin = "Union Depot, Minnesota",
                              destination = "Target Field, Minnesota",
                              key = key,
                              mode = 'transit')
...
```
```{r}
Mcdicks_2 <- google_places(search_string = "McDonalds", location = c(44.97566,-93.2696761), radius = 24140, key = c("AIzaSyDea9BHdMYeXvLUjJObACk2Ox8ofse2m68"), page_token = Mcdicks$next_page_token)

McData2<-Mcdicks_2$results[2]$geometry$location
